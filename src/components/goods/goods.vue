        ...
        <li v-for="(item,index) in goods" class="menu-item"
          ...
          <span class="text border-1px">
            <span class="icon" :class="classMap[item.type]"
                  v-if="item.type>0"></span>{{item.name}}</span>
        </li>
      </ul>
    </div>
    <div class="foods-wrapper" ref="foodsWrapper">
      <ul>
        <li v-for="item in goods" class="food-list food-list-hook">
          ...
          <ul>
            <li @click="foodDetail(food,$event)" v-for="food in item.foods" class="food-item border-1px">
              <div class="icon">
                <img :src="food.icon" width="54" height="54">
              </div>
              <div class="content">
                ...
                <div class="cartcontrol-wrapper">
                  <cartcontrol :food="food" rel="food"></cartcontrol>
                </div>
              </div>
            </li>
          </ul>
